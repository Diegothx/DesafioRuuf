...
def calculate_panels(panel_width: int, panel_height: int,
                     roof_width: int, roof_height: int, overlap_width: int, overlap_height: int) -> int: 
    roof_grid = []

    for i in range(2 * roof_width - overlap_width):
        if i < roof_width - overlap_width:
            row = [0] * roof_height + [1] * (roof_height - overlap_height)
        elif i < roof_width:
            row = [0] * (2 * roof_height - overlap_height)
        else:
            row = [1] * (roof_height - overlap_height) + [0] * roof_height
